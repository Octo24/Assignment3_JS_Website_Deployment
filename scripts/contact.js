...
//    contents of the contact-page are replaced with a single
//     <p> element that reads "Thank you for your message" in
//      size 24 font.
...
document.getElementById('submit-button').addEventListener('click', function clearForm() {
